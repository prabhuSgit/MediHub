...
public class CustomerBookingDoctorJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        searchBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/CustomerRole/search.png"))); // NOI18N
        ...
        doctorTbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Doctor", "Provider", "Timing", "Rating", "No of Reviewers", "Department"
            }
        ) {
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                            ...
                                            .addGap(11, 11, 11)
                                            .addComponent(slotDropDown, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        // TODO add your handling code here:
        if(slotDropDown.getSelectedItem().equals("<Select Slot>")){
            JOptionPane.showMessageDialog(null, "Kindly select the slot");
        }else{
            populate();
        }
       ...
       for (Organization o : e.getOrganizationDirectory().getOrganizationList()) {
           for (UserAccount acc : o.getUserAccountDirectory().getUserAccountList()) {
               if (acc.getRole().toString().equals("Business.Role.DoctorRole")) {
                   ...
                   row[5] = acc.getEmployee().getDepartment();
                   dtm.addRow(row);
               }
           }
       }
